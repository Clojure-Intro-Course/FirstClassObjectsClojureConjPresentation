...
\frametitle{Above and Beside}
	...
	\begin{figure}
	\vspace{-1cm}
	\includegraphics[width=6cm]{PresentationImages/greenScaleRects.pdf}
	\hspace{1.5cm}
...
\frametitle{Overlay}
	...
	\end{itemize}
	\begin{figure}
	\includegraphics[width=5.5cm]{PresentationImages/greenHoleCode.pdf}
	\hspace{1cm}
...
\frametitle{Images}
	...
	\begin{figure}
		...
		\hspace{0.4cm}
		\includegraphics[width=5.5cm]{PresentationImages/pictureOnBoxCode.pdf}
		\hspace{0.4cm}
		\includegraphics[width=2.6cm]{PresentationImages/onBoxKappa.pdf}
	\end{figure}
...
\emcomment{Say that this implementation is different from Racket (on the slide, or at least mention)}
	\begin{itemize}
		...
		\item This allows for us to iterate over a complex shape \emcomment{For the ability to access individual simple shapes? To iterate over...?}
	\end{itemize}
\end{frame}
...
\frametitle{Combining Complex Shapes}
	\begin{itemize}
		...
		\begin{figure}
			\includegraphics[width=4cm]{PresentationImages/twoComplex.pdf}
		\end{figure}
	\end{itemize}
\end{frame}
