...
\frametitle{Images}
	\begin{itemize}
		\item images can be rotated and scaled similar to shapes \emcomment{rotate the image, show an example of combining an image with a rectangle or some such}
	\end{itemize}
	\begin{figure}
		\vspace{-0.3cm}
